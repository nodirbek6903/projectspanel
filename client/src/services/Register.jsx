...
const Register = () => {
  ...
  const validatePassword = () => {
    ...
    if (!passwordRegex.test(password)) {
      setPasswordError(
        "Parol kamida 8 ta belgidan iborat bo'lishi kerak, kamida bitta katta harf, bitta kichik harf va bitta raqamdan iborat bo'lishi kerak."
      );
    } else {
      setPasswordError("");
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (passwordError) {
      toastr.warning("Parol talablarga javob bermaydi.");
      return;
    }
    ...
    try {
      ...
      if (data.status === "ok") {
        ...
        toastr.warning("Bunday foydalanuvchi mavjud.");
      }
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border bg-white p-10 text-gray-700 shadow-none">
          ...
          <div className="inline-flex items-center">
            ...
            >
              <p className="flex items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
                I agree the
                <Link className="font-semibold transition-colors hover:text-blue-600">
